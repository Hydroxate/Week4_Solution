...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slider1 = (SeekBar) findViewById(R.id.volume1);
        slider2 = (SeekBar) findViewById(R.id.volume2);
        ...
        Switch onOffSwitch2 = (Switch) findViewById(R.id.onOffSwitch2);//declared the switch here pointing to id onOffSwitch
        ...
        slider1.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                sendFloatPD("volume1", slider1Value);
            }
        ...
        slider2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                sendFloatPD("volume2", slider2Value);
            }
